...
class ScenarioTreeManagerSolver(PySPConfiguredObject):
    ...
    def solve_subproblems(self,
        ...
        Args:
            ...
            async_ (bool): When set to :const:`True`, an
        ...
        Examples:
            ...
            >>> job = sp.solve_subproblems(async_=True)
            >>> # ... do other things ... #
    ...
    def solve_scenarios(self,
        ...
        Examples:
            ...
            >>> job = sp.solve_scenarios(async_=True)
            >>> # ... do other things ... #
            >>> results = job.complete()
            >>> results.pprint()
    ...
    def solve_bundles(self,
        ...
        Examples:
            ...
            >>> job = sp.solve_bundles(async_=True)
            >>> # ... do other things ... #
            >>> results = job.complete()
            >>> results.pprint()
...
def ScenarioTreeManagerSolverFactory(sp, *args, **kwds):
    ...
    Example:
        ...
        >>> with ScenarioTreeManagerSolverFactory(sp) as manager:
        >>>    job = manager.solve_subproblems(async_=True)
